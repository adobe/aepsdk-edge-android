...
upstream-integration-test:
	...
	(./code/gradlew -p code/upstream-integration-tests connectedDebugAndroidTest -PMOBILE_PROPERTY_ID=$(MOBILE_PROPERTY_ID) -PEDGE_LOCATION_HINT=$(EDGE_LOCATION_HINT))
